...
public class RecyclerView_Config {
    ...
    class MovieItemView extends RecyclerView.ViewHolder{
        ...
        public MovieItemView(ViewGroup parent){
            ...
            mname=(TextView)itemView.findViewById(R.id.txtmoviename);
            mcategory=(TextView)itemView.findViewById(R.id.txtcategory);
            mpoint=(TextView)itemView.findViewById(R.id.txtpoint);
            mdescrip=(TextView)itemView.findViewById(R.id.txtdescrip);
